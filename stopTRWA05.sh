...
# hostname for ND is running on
ND_HOSTNAME=localhost
# port for ND is listen on
ND_PORT=8879

ROOTDIR=/home/dj810694/IBM/WebSphere/AppClient05
PATH=$PATH:$HOME/bin:$ROOTDIR/java/bin
CLASSPATH=$ROOTDIR/lib:$ROOTDIR/plugins:.

export PATH
export CLASSPATH

# use this to see thread dump
#java -agentlib:hprof=cpu=samples,interval=20,depth=40 -classpath \

# use this not to see thread dump
#java -DtraceSettingsFile=TraceSettings.properties -classpath \
...
. \
 com.toprunner.websphere.pmi.TRWSPMI $ND_HOSTNAME $ND_PORT 1 no TRWSPMI.conf
